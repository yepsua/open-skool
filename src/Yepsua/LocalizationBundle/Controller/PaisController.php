...
namespace Yepsua\LocalizationBundle\Controller;
...
use Yepsua\LocalizationBundle\Entity\Pais;
use Yepsua\LocalizationBundle\Form\PaisType;
...
class PaisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $grid->setTranslator($this->get('translator'), 'YepsuaLocalizationBundle_Pais');
        $grid->createView();
    ...
    public function dataAction()
    {
        try{
            ...
            $repository = $em->getRepository('YepsuaLocalizationBundle:Pais');
    ...
    public function kanbanAction()
    {
        ...
        $entities = $em->getRepository('YepsuaLocalizationBundle:Pais')->findAll();
     ...
     * @Method("POST")
     * @Template("YepsuaLocalizationBundle:Pais:new.html.twig")
     */
        ...
        try{
            ...
            if ($form->isValid()) {
                ...
                if($this->getRequest()->get('_loop_create')){
                    ...
                    return $this->render('YepsuaLocalizationBundle:Pais:new.html.twig',array(
                      'entity'      => $entity,
                      'form' => $form->createView())
                    ); 
                }else{
                    $deleteForm = $this->createDeleteForm($entity->getId());
                    return $this->render('YepsuaLocalizationBundle:Pais:show.html.twig',array(
                      'entity' => $entity,
    ...
    public function showAction($id)
    {
        try{
            ...
            $entity = $em->getRepository('YepsuaLocalizationBundle:Pais')->find($id);
     ...
     * @Method("POST")
     * @Template("YepsuaLocalizationBundle:Pais:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        try{
            ...
            return $this->render('YepsuaLocalizationBundle:Pais:edit.html.twig', array(
                'entity'      => $entity,
                'edit_form'   => $editForm->createView(),
                'delete_form' => $deleteForm->createView(),
            ), new Response(null, 202));
    ...
    public function deleteAction(Request $request, $id)
    {
        try{
            ...
            if ($form->isValid()) {
                $em = $this->getDoctrine()->getManager();
                $entities = $em->getRepository('YepsuaLocalizationBundle:Pais')->findById($id);
