...
class RoleController extends Controller
{
    ...
    /**
     * Public service - All Role entities
     * @Route("/data", name="role_data")
     * @Method("GET")
     */
    public function dataAction()
    {
        try{
            ...
            $repository = $em->getRepository('YepsuaSecurityBundle:Role');
            $count = Dao::count($repository);
            
            if($count > 0){
                $query = Dao::buildQuery($repository, 'role', $orderBy, $sord, $filters);
     ...
     * @Method("POST")
     * @Template("YepsuaSecurityBundle:Role:new.html.twig")
     */
        ...
        try{
            ...
            if ($form->isValid()) {
                ...
                if($this->getRequest()->get('_loop_create')){
                    ...
                    return $this->render('YepsuaSecurityBundle:Role:new.html.twig',array(
                      'entity'      => $entity,
                      'form' => $form->createView())
                    ); 
                }else{
                    $deleteForm = $this->createDeleteForm($entity->getId());
                    return $this->render('YepsuaSecurityBundle:Role:show.html.twig',array(
                      'entity' => $entity,
     ...
     * @Method("PUT")
     * @Template("YepsuaSecurityBundle:Role:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        try{
            ...
            return $this->render('YepsuaSecurityBundle:Role:edit.html.twig', array(
                'entity'      => $entity,
                'edit_form'   => $editForm->createView(),
                'delete_form' => $deleteForm->createView(),
            ), new Response(null, 202));
    ...
    public function deleteAction(Request $request, $id)
    {
        try{
            ...
            if ($form->isValid()) {
                $em = $this->getDoctrine()->getManager();
                $entities = $em->getRepository('YepsuaSecurityBundle:Role')->findById($id);
