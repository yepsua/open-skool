 ...
 * @ORM\Entity(repositoryClass="OpenSkool\PeopleBundle\Entity\Repository\PersonRepository")
 */
class Person
{
    /**
     ...
     * Set idType
     *
     * @param \Yepsua\LOVBundle\Entity\LOV $idType
     * @return Person
     */
    public function setIdType(\Yepsua\LOVBundle\Entity\LOV $idType = null)
    {
        $this->idType = $idType;
